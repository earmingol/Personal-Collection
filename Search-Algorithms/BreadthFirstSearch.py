...
# BFS with recursive function to solve a puzzle

from TreeStructures import Node

def recursive_BFS(solution, border_list, visited_nodes):
    node = None
    if len(border_list) > 0:
        node = border_list.pop(0)
...
if __name__ == "__main__":
    ...
    solution_node = recursive_BFS(solution, border_list, [])
